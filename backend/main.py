...
app.include_router(incomes_router := income.router, prefix="/api/incomes", tags=["Receitas"])
...
app.include_router(ai_advisor.router,    prefix="/api/ai",            tags=["IA"])


@app.get("/")
async def root():
    return {"message": "fintech.ai API v2.0", "status": "online"}
